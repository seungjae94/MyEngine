...
{
    {
        ...
        HRESULT Result = Device->CreateBuffer(&BufferDesc, &BufferInitialData, &TriangleVertexBuffer);
...

    {
        ...
        HRESULT Result = Device->CreateBuffer(&BufferDesc, &BufferInitialData, &TriangleIndexBuffer);

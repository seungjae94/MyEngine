...
{
    {
        ...
        EngineVertexBuffer::Create("Rect", Vertices);
    }

    {
        ...
        EngineIndexBuffer::Create("Rect", Indexes);
    }
    ...
    {"TEXCOORD", 0, DXGI_FORMAT::DXGI_FORMAT_R32G32_FLOAT, 0, 16, D3D11_INPUT_PER_VERTEX_DATA, 0 }
        ...
        EngineVertex::InputElementDescs = InputElementDescs;
    }
}
...
void EngineDirectDevice::CreateVSResources()
{
    ...
    for (EnginePath& ShaderPath : ShaderPaths)
    {
        ...
        EngineVertexShader::Create(ShaderPath.GetFilename(), ShaderPathString);
    }
}
...
void EngineDirectDevice::CreatePSResources()
{
    // 픽셀 셰이더 생성
    {
        ...
        for (EnginePath& ShaderPath : ShaderPaths)
        {
            ...
            EnginePixelShader::Create(ShaderPath.GetFilename(), ShaderPathString);
        }
    }
    ...
    // 샘플러 스테이트 생성
    {
        ...
        EngineSamplerState::Create("Point", Desc);
    }
}
...
{
    {
        ...
        EngineBlendState::Create("Default", Desc);
    }
}
